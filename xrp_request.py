...
def make_and_send(hmac: str, wallet_id, to_address="", value="", coin="xrp", memo=None, total=0,
                  privkey: str = '', _coin="xrp"):
...
def make_tx(hmac: str, wallet_id, to_address="", value="", coin="xrp", memo=None, total=0, _coin="xrp"):
    resp = requests.post(
...
def sign_tx(unsigned_tx="", privkey="", _coin: str = "xrp"):
    resp = requests.post(
...
def send_tx(hmac: str, wallet_id: str, signed_tx: str, sequence_id: int, _coin: str = "xrp"):
    resp = requests.post(
