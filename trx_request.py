...
def make_and_send(hmac: str, wallet_id, to_address="", value="", coin="trx", memo=None, total=0,
                  privkey: str = '', _coin="trx"):
...
def make_tx(hmac: str, wallet_id, to_address="", value="", coin="trx", memo=None, total=0, _coin="trx"):
    resp = requests.post(
...
def sign_tx(unsigned_tx="", privkey="", _coin: str = "trx"):
    parameters = {"sig_payload": unsigned_tx, "prikey": privkey}
    resp = requests.post(
...
def send_tx(hmac: str, wallet_id: str, signed_tx: str, sequence_id: int, _coin: str = "trx"):
    resp = requests.post(
